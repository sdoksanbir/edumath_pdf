...
from users.models import CustomUser, Subject

class TeacherForm(forms.ModelForm):
    class Meta:
        model = CustomUser
        fields = ['first_name', 'last_name', 'email', 'tc_no', 'phone_number', 'subject']
        labels = {
            'first_name': 'Ad',
            'last_name': 'Soyad',
            'email': 'E-Posta',
    ...
    subject = forms.ModelChoiceField(
        queryset=Subject.objects.all(),  # Veritabanındaki tüm branşları getir
        empty_label="Branş Seçin",  # Varsayılan olarak gösterilecek metin
        label='Branş'
    )
